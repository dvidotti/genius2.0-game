...
function playMelody() { 
  ...
  for (let i = 0; i < audioSeq.length; i += 1) {
    if (i < audioSeq.length - 1) {
      audioSeq[i].addEventListener('ended', () => {
        ...
        if (audioSeq[i + 1].src === 'https://dvidotti.github.io/genius2.0-game/c.mp3'){ 
         
          playButton[0].classList.add('red')
          setTimeout(() => {  
            playButton[0].classList.remove('red')
          }, 500); 
        } else if (audioSeq[i + 1].src === 'https://dvidotti.github.io/genius2.0-game/e.mp3'){
          playButton[1].classList.add('yellow')
          setTimeout(() => {  
            playButton[1].classList.remove('yellow')
          }, 500); 
        } else if (audioSeq[i + 1].src === 'https://dvidotti.github.io/genius2.0-game/g.mp3'){
          playButton[2].classList.add('blue')
          setTimeout(() => {  
          playButton[2].classList.remove('blue')
          }, 500); 
        } else if (audioSeq[i + 1].src === 'https://dvidotti.github.io/genius2.0-game/a.mp3'){
          playButton[3].classList.add('green')
          setTimeout(() => {  
          playButton[3].classList.remove('green')
          }, 500); 
  ...
  audioSeq[0].play();
   if (userPoints <= 7){
    if (audioSeq[0].src === 'https://dvidotti.github.io/genius2.0-game/c.mp3'){ 
      playButton[0].classList.add('red')
      setTimeout(() => {  
        playButton[0].classList.remove('red')
      }, 500); 
    } else if (audioSeq[0].src === 'https://dvidotti.github.io/genius2.0-game/e.mp3'){
      playButton[1].classList.add('yellow')
      setTimeout(() => {  
        playButton[1].classList.remove('yellow')
      }, 500); 
    } else if (audioSeq[0].src === 'https://dvidotti.github.io/genius2.0-game/g.mp3'){
      playButton[2].classList.add('blue')
      setTimeout(() => {  
      playButton[2].classList.remove('blue')
      }, 500); 
    } else if (audioSeq[0].src === 'https://dvidotti.github.io/genius2.0-game/a.mp3'){
      playButton[3].classList.add('green')
      setTimeout(() => {  
      playButton[3].classList.remove('green')
      }, 500); 
